...
if html.ok:
    #infos = BeautifulSoup(re.findall('CHINA.*MACAO', html.text)[0], 'lxml') #中国站点
    # .* 是贪婪匹配的意思：能匹配的最大部分，
    infos = BeautifulSoup(re.findall('California.*Uttarakhand', html.text)[0], 'lxml')#全球站点
    ...
    df.to_csv('cities_china_url_3.csv')
